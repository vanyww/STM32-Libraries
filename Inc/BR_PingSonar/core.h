...
typedef enum
{
   ...
   BR_PING_SONAR_STATUS_DATA_ERROR,
...
BR_PingSonarStatus BR_PingSonarTryReadData(__SDEVICE_HANDLE(BR_PingSonar)*, uint16_t, void *, size_t *);
BR_PingSonarStatus BR_PingSonarTryWriteData(__SDEVICE_HANDLE(BR_PingSonar)*, uint16_t, const void *, size_t);
